...
func init() {
    ...
    "Translation": {
        "CN": {
            ...
            "Recommendation": "<p><span style=\"color: var(--primaryFont-color);\">厂商已发布了漏洞修复程序，请及时关注更新：<a href=\"http://www.oa8000.com/\">http://www.oa8000.com/</a></span><br></p>",
            "Impact": "<p><span style=\"color: rgb(53, 53, 53); font-size: 14px;\">攻击者可通过该漏洞下载系统重要文件（如数据库配置文件、系统配置文件），并配合下载文件内容顺利进入数据库或者系统的敏感信息，导致网站或者服务器沦陷。</span><br></p>",
            "VulType": [
                "文件读取"
            ],
            "Tags": [
        ...
        "EN": {
            "Name": " Huatian power collaborative office system / oaapp / JSP / trace / ntkodownload JSP arbitrary file download vulnerability",
            "Product": "Huatian-OA8000",
            "Description": "<p><span style=\"color: var(--primaryFont-color);\">Huatian power collaborative office system combines advanced management ideas and modes with software technology and network technology to provide users with a low-cost and efficient collaborative office and management platform.</span><br></p><p>Huatian power OA system has a vulnerability of arbitrary file download</p>",
            ...
            "Impact": "<p><span style=\"color: rgb(53, 53, 53); font-size: 14px;\">Attackers can use this vulnerability to read the leaked source code, database configuration files, etc., resulting in an extremely insecure website.</span><br></p>",
            "VulType": [
                "File Read"
            ],
            "Tags": [
