...
func init() {
	expJson := `{
    "Name": "Spring Cloud Function functionRouter Api SPEL  Vulnerability (CVE-2022-22950)",
    ...
    "Translation": {
        "CN": {
            "Name": "Spring Cloud Function SPEL functionRouter 接口远程命令执行漏洞（CVE-2022-22950）",
            "Product": "Spring Cloud Function",
