...
func init() {
    ...
    "Description": "<p>NSFOCUS Next Generation Firewall is a dedicated security firewall device.</p><p>There is an arbitrary file upload vulnerability in the NSFOCUS next-generation firewall bugsInfo/resourse.php file. An attacker can upload a malicious Trojan to gain server permissions.</p>",
    "Impact": "nsfocus resourse.php arbitrary file upload vulnerability",
    "Recommendation": "<p>1. Block 8081 port access. 2. Pay attention to the update of the official website in time: <a href=\"https://www.nsfocus.com.cn/\">https://www.nsfocus.com.cn/</a></p>",
    "Product": "nsfocus",
    "VulType": [
        "Code Execution"
    ],
