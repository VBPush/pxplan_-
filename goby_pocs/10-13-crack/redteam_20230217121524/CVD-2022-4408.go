...
func init() {
    ...
    "Translation": {
        "CN": {
            ...
            "Recommendation": "<p><span style=\"color: var(--primaryFont-color);\">TurboMail 邮件系统可以</span><span style=\"color: var(--primaryFont-color);\">对路径进行限制，通过黑名单机制限制文件名不能包含 / 不能跨目录。</span><br></p>",
            "Impact": "<p><span style=\"color: rgb(22, 28, 37); font-size: 16px;\">TurboMail邮件系统存在文件读取漏洞，攻击者可以通过 /viewfile 端点该漏洞读取配置文件，进而对 password 进行 base64 解密后，登录后台 /maintlogin.jsp。</span><br></p>",
            "VulType": [
                "文件读取"
            ],
            "Tags": [
