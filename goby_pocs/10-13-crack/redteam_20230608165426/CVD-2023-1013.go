...
func init() {
	expJson := `{
    "Name": "XETUX dynamiccontent.properties.xhtml RCE",
    "Description": "<p>XETUX is a comprehensive solution comprising a set of safe, powerful and monitorable software programs, designed and developed for automatic control of restaurants and retail.</p><p>There is a code execution vulnerability in XETUX, an attacker can execute arbitrary code through dynamiccontent.properties.xhtml to gain server privileges.</p>",
    "Product": "XETUX",
    "Homepage": "https://xetux.com/",
    "DisclosureDate": "2023-01-29",
    "Author": "corp0ra1",
    "FofaQuery": "title=\"@XETUX\" && title=\"XPOS\" && body = \"BackEnd\"",
    "GobyQuery": "title=\"@XETUX\" && title=\"XPOS\" && body = \"BackEnd\"",
    "Level": "3",
    "Impact": "<p>There is a code execution vulnerability in XETUX, an attacker can execute arbitrary code through dynamiccontent.properties.xhtml to gain server privileges.</p>",
    "Recommendation": "<p>The manufacturer has released security patches, please pay attention to the official website for updates: <a href=\"https://xetux.com/.\">https://xetux.com/.</a></p>",
    "References": [],
    "Is0day": false,
    "HasExp": true,
    "ExpParams": [
    ...
    "ScanSteps": [
        "AND",
        {
            "Request": {
                "method": "POST",
                "uri": "/xc-one-pos/javax.faces.resource/dynamiccontent.properties.xhtml",
    ...
    "Translation": {
        "CN": {
            "Name": "XETUX 软件 dynamiccontent.properties.xhtml 远程代码执行漏洞",
            "Product": "XETUX",
            "Description": "<p>XETUX 是一个全面的解决方案，包括一套安全、强大和可监控的软件程序，专为自动控制餐厅和零售而设计和开发。<br></p><p>XETUX 存在代码执行漏洞，攻击者可通过 dynamiccontent.properties.xhtml 执行任意代码获取服务器权限。<br></p>",
            "Recommendation": "<p>厂商已发布安全补丁，请及时关注官网更新：<a href=\"https://xetux.com/\">https://xetux.com/</a>。<br></p>",
            "Impact": "<p>XETUX 存在代码执行漏洞，攻击者可通过 dynamiccontent.properties.xhtml 执行任意代码获取服务器权限。<br></p>",
            "VulType": [
                "代码执行"
            ],
            "Tags": [
        ...
        "EN": {
            "Name": "XETUX dynamiccontent.properties.xhtml RCE",
            "Product": "XETUX",
            "Description": "<p>XETUX is a comprehensive solution comprising a set of safe, powerful and monitorable software programs, designed and developed for automatic control of restaurants and retail.<br></p><p>There is a code execution vulnerability in XETUX, an attacker can execute arbitrary code through dynamiccontent.properties.xhtml to gain server privileges.<br></p>",
            "Recommendation": "<p>The manufacturer has released security patches, please pay attention to the official website for updates: <a href=\"https://xetux.com/.\">https://xetux.com/.</a><br></p>",
            "Impact": "<p>There is a code execution vulnerability in XETUX, an attacker can execute arbitrary code through dynamiccontent.properties.xhtml to gain server privileges.<br></p>",
            "VulType": [
                "Code Execution"
            ],
            "Tags": [
