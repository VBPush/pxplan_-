...
func init() {
	expJson := `{
    "Name": "Yonyou NC 6.5 accept.jsp  Arbitrary File Upload Vulnerability",
    "Description": "<p>Yonyou NC is a management software for group companies under China UFIDA Group.</p><p>Yonyou NC  /aim/equipmap/accept.jsp routing has an arbitrary file upload vulnerability, which allows attackers to upload arbitrary files, execute arbitrary code on the server, and obtain webshell.</p>",
    "Impact": "Yonyou NC 6.5 accept.jsp  Arbitrary File Upload Vulnerability",
    ...
    "Translation": {
        "CN": {
            "Name": "用友 NC 6.5 accept.jsp 任意文件上传漏洞",
        ...
        "EN": {
            "Name": "Yonyou NC 6.5 accept.jsp  Arbitrary File Upload Vulnerability",
            "Description": "<p>Yonyou NC is a management software for group companies under China UFIDA Group.</p><p><span style=\"font-size: 16px; color: rgb(0, 0, 0);\">Yonyou NC<span style=\"color: rgb(22, 28, 37); font-size: 16px;\">&nbsp;&nbsp;</span><span style=\"color: rgb(22, 28, 37); font-size: 16px;\">/aim/equipmap/accept.jsp</span><span style=\"color: rgb(22, 28, 37); font-size: 16px;\">&nbsp;</span></span><span style=\"font-size: 16px; color: rgb(0, 0, 0);\">routing has an arbitrary file upload vulnerability, which allows attackers to upload arbitrary files, execute arbitrary code on the server, and obtain webshell.</span><br></p>",
            "Impact": "Yonyou NC 6.5 accept.jsp  Arbitrary File Upload Vulnerability",
            "Recommendation": "<p>The vendor has released a bug fix, please pay attention to the update in time: <a href=\"https://www.yonyou.com/\">https://www.yonyou.com/</a></p><p>1. Set access policies and whitelist access through security devices such as firewalls.</p><p>2.If not necessary, prohibit public network access to the system.</p>",
            "Product": "Yonyou-NC",
            "VulType": [
