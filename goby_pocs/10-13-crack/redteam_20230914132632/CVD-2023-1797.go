...
func init() {
    ...
    "Recommendation": "<p>The vendor has released a bug fix, please pay attention to the update in time: <a href=\"https://www.e-office.cn/\">https://www.e-office.cn/</a></p><p/><p>Temporary fix:</p><p>1. Set access policies and whitelist access through security devices such as firewalls.</p><p>2. If not necessary, prohibit public network access to the system.</p>",
    "References": [
    ...
    "Translation": {
        "CN": {
            "Name": "泛微 E-office 办公系统 Init.php getSelectList_Crm SQL 注入漏洞",
            "Product": "泛微-EOffice",
            ...
            "Recommendation": "<p>厂商已发布了漏洞修复程序，请及时关注更新：<a href=\"https://www.e-office.cn/\">https://www.e-office.cn/</a></p><p><br></p><p>临时修复方案：</p><p>1、通过防火墙等安全设备设置访问策略，设置白名单访问。</p><p>2、如非必要，禁止公网访问该系统。</p>",
        ...
        "EN": {
            ...
            "Product": "Weaver-EOffice",
            "Description": "<p>Weaver e-office is an OA product launched by Weaver Company for small and medium-sized organizations.</p><p>There is a SQL injection vulnerability in the cc_parent_id parameter sent by Weaver e-office via POST when passing ?m=getSelectList_Crm to the /E-mobile/App/Init.php route.</p>",
            "Recommendation": "<p>The vendor has released a bug fix, please pay attention to the update in time: <a href=\"https://www.e-office.cn/\">https://www.e-office.cn/</a></p><p><br></p><p>Temporary fix:</p><p>1. Set access policies and whitelist access through security devices such as firewalls.</p><p>2. If not necessary, prohibit public network access to the system.</p>",
