...
func init() {
	expJson := `{
    "Name": "Command Execution Vulnerability in Hikvision Operations Management Center",
    "Description": "<p>Hikvision is a video-centric provider of intelligent IoT solutions and big data services. A command execution vulnerability exists in the operation and management center system of Hangzhou Hikvision Digital Technology Co. An attacker could use the vulnerability to gain server privileges.</p>",
    "Product": "Haikang Operation Management Center",
    "Homepage": "https://www.hikvision.com/cn/products/",
    "DisclosureDate": "2023-02-21",
    "Author": "goby777_",
    "FofaQuery": "header=\"X-Content-Type-Options: nosniff\" && body=\"<h1>Welcome to OpenResty!</h1>\" && header=\"X-Xss-Protection: 1; mode=block\"",
    "GobyQuery": "header=\"X-Content-Type-Options: nosniff\" && body=\"<h1>Welcome to OpenResty!</h1>\" && header=\"X-Xss-Protection: 1; mode=block\"",
    "Level": "3",
    "Impact": "<p>The attacker can obtain server privileges without authentication, and due to the existence of relevant dependencies, even if the server is not able to remotely load the malicious class without the network, it can be executed through the local chain directly command, thus obtaining server privileges.</p>",
    "Recommendation": "<p>The latest version has fixed the vulnerability, upgrade the system version to the latest version :<a href=\"https://www.hikvision.com/cn/19th-asian-games/isecure-center/?q=%E6%B5%B7%E5%BA%B7%E5%9F%9F%E8%A7%81%E7%BB%BC%E5%90%88%E5%AE%89%E9%98%B2%E7%AE%A1%E7%90%86%E5%B9%B3%E5%8F%B0\">https://www.hikvision.com/cn/19th-asian-games/isecure-center/?q=%E6%B5%B7%E5%BA%B7%E5%9F%9F%E8%A7%81%E7%BB%BC%E5%90%88%E5%AE%89%E9%98%B2%E7%AE%A1%E7%90%86%E5%B9%B3%E5%8F%B0</a></p>",
    "References": [],
    "Is0day": false,
    "HasExp": true,
    "ExpParams": [
    ...
    "Translation": {
        "CN": {
            "Name": "海康运行管理中心命令执行漏洞",
            "Product": "海康运行管理中心",
            "Description": "<p>海康威视是以视频为核心的智能物联网解决方案和大数据服务提供商。杭州海康威视数字技术股份有限公司运行管理中心系统存在命令执行漏洞，攻击者可利用该漏洞获取服务器权限。</p>",
            "Recommendation": "<p>最新版已修复该漏洞，升级系统版本至最新版即可:<a href=\"https://www.hikvision.com/cn/19th-asian-games/isecure-center/?q=%E6%B5%B7%E5%BA%B7%E5%9F%9F%E8%A7%81%E7%BB%BC%E5%90%88%E5%AE%89%E9%98%B2%E7%AE%A1%E7%90%86%E5%B9%B3%E5%8F%B0\" target=\"_blank\">https://www.hikvision.com/cn/19th-asian-games/isecure-center/?q=%E6%B5%B7%E5%BA%B7%E5%9F%9F%E8%A7%81%E7%BB%BC%E5%90%88%E5%AE%89%E9%98%B2%E7%AE%A1%E7%90%86%E5%B9%B3%E5%8F%B0</a></p>",
            "Impact": "<p>海康运行管理中心系统使用低版本的fastjson，攻击者可在未鉴权情况下获取服务器权限，且由于存在相关依赖，即使服务器不出网无法远程加载恶意类也可通过本地链直接命令执行，从而获取服务器权限。</p>",
            "VulType": [
                "命令执行"
            ],
            "Tags": [
        ...
        "EN": {
            "Name": "Command Execution Vulnerability in Hikvision Operations Management Center",
            "Product": "Haikang Operation Management Center",
            "Description": "<p>Hikvision is a video-centric provider of intelligent IoT solutions and big data services. A command execution vulnerability exists in the operation and management center system of Hangzhou Hikvision Digital Technology Co. An attacker could use the vulnerability to gain server privileges.<br></p>",
            "Recommendation": "<p>The latest version has fixed the vulnerability, upgrade the system version to the latest version :<a href=\"https://www.hikvision.com/cn/19th-asian-games/isecure-center/?q=%E6%B5%B7%E5%BA%B7%E5%9F%9F%E8%A7%81%E7%BB%BC%E5%90%88%E5%AE%89%E9%98%B2%E7%AE%A1%E7%90%86%E5%B9%B3%E5%8F%B0\" target=\"_blank\">https://www.hikvision.com/cn/19th-asian-games/isecure-center/?q=%E6%B5%B7%E5%BA%B7%E5%9F%9F%E8%A7%81%E7%BB%BC%E5%90%88%E5%AE%89%E9%98%B2%E7%AE%A1%E7%90%86%E5%B9%B3%E5%8F%B0</a><br></p>",
            "Impact": "<p>The attacker can obtain server privileges without authentication, and due to the existence of relevant dependencies, even if the server is not able to remotely load the malicious class without the network, it can be executed through the local chain directly command, thus obtaining server privileges.</p>",
            "VulType": [
                "Command Execution"
            ],
